/*
  ...
  - You are about to drop the `SuggestionInformation` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropTable
DROP TABLE `SuggestionInformation`;

-- CreateTable
CREATE TABLE `suggestion_information` (
